...
<table  width="68%" border="0" cellspacing="0" cellpadding="0" class="trstyle">
  <tr><form id="form1" name="form1" method="post" action="graduation_score_go.php">
     <td width="450">
  ...
  <tr><td colspan="4">
  <iframe name="window" width="100%" height="600" frameborder="0" src="blank.php"></iframe></td><tr>
</table>
</body>
</html>