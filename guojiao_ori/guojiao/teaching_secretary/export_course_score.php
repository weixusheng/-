...
$sql=mysql_query("select ID,c_week_hour,c_teacher,credit from tb_course2_term where cb_id='$cb_id' and c_class='$class_name';");
$info=mysql_fetch_array($sql);
...
if($way==0){
	...
	$sql20=mysql_query("select avg(score) as aver from tb_score where  s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id'");
	$info20=mysql_fetch_array($sql20);
	$sql21=mysql_query("select STD(score) as biaozhuncha from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id'");
	$info21=mysql_fetch_array($sql21);
	//名单查询
	$sql1342=mysql_query("select count(s_id) as no_num from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id' and score<60 and score is not NULL;");
	...
	$info2=mysql_fetch_array($sql2);
		...
		do{
			$num++;
			$s_id=$info2["s_id"];
			$sql=mysql_query("select s_name from tb_s_information where ID='$s_id' and (stu_status=0 or stu_status=4);");
			$info=mysql_fetch_array($sql);
	...
	$sql32=mysql_query("select s_id from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id' and exam_type=1;");
	...
	$sql22=mysql_query("select s_id from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id' and exam_type=2;");
	...
	$sql22=mysql_query("select s_id from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id' and exam_type=3;");
	$info22=mysql_fetch_array($sql22);
	$s_name00="";
	if($info22==true){
		$num=0;
...
if($way==1){
	...
	if(substr($major_00,0,1)=='E'){
		...
		else
		{
		  ...
		  $part4_a=number_format($part4/$should_num0*100,2);
		  $part5_a=number_format($part5/$should_num0*100,2);
		  $part6_a=number_format($part6/$should_num0*100,2);
		  $part7_a=number_format($part7/$should_num0*100,2);
		  $part8_a=number_format($part8/$should_num0*100,2);
		  $part9_a=number_format($part9/$should_num0*100,2);
		  $part10_a=number_format($part10/$should_num0*100,2);
		  $part11_a=number_format($part11/$should_num0*100,2);
		}
	}
...
if($way==2){
	...
	$sql20=mysql_query("select avg(ck1_score) as aver from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id'");
	$info20=mysql_fetch_array($sql20);
	$sql21=mysql_query("select STD(ck1_score) as biaozhuncha from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id'");
	$info21=mysql_fetch_array($sql21);
	//名单查询
	$sql1342=mysql_query("select count(s_id) as no_num from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id' and ck1_score<60 and ck1_score is not NULL;");
	$info1342=mysql_fetch_array($sql1342);
	$s_name2='';
	$s_name2000="";
	if($info1342['no_num']!=0){
...
if($way==3){
	...
	$info20=mysql_fetch_array($sql20);
	$sql21=mysql_query("select STD(ck2_score) as biaozhuncha from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id'");
	$info21=mysql_fetch_array($sql21);
	//名单查询
	$sql1342=mysql_query("select count(s_id) as no_num from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id' and ck2_score<60 and ck2_score is not NULL;");
	$info1342=mysql_fetch_array($sql1342);
	$s_name2='';
	$s_name2000="";
	if($info1342['no_num']!=0){
...
if($way==4){
	...
	$sql20=mysql_query("select avg(ck3_score) as aver from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id'");
	$info20=mysql_fetch_array($sql20);
	$sql21=mysql_query("select STD(ck3_score) as biaozhuncha from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id'");
	$info21=mysql_fetch_array($sql21);
	//名单查询
	$sql1342=mysql_query("select count(s_id) as no_num from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and  c_id='$c_id' and ck3_score<60 and ck3_score is not NULL;");
	$info1342=mysql_fetch_array($sql1342);
	$s_name2='';
	$s_name2000="";
	if($info1342['no_num']!=0){
...
$sql25=mysql_query("select s_id,score,bk_score,ck1_score,ck2_score,ck3_score from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and c_id='$c_id';");
for($i=6;$i<36;$i++){
	...
	$sql26=mysql_query("select s_no,s_name from tb_s_information where ID='$s_id' and (stu_status=0 or stu_status=4);");
