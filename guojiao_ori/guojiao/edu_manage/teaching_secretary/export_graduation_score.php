...
$objPHPExcel->setActiveSheetIndex(0)
			...
			for($j=1;$j<9;$j++)
			{
				...
				where tb_course2_term.c_class='$now_class' and tb_course2_term.term='$grade_term' and tb_course_base.ID=tb_course2_term.cb_id and tb_score.c_id=tb_course2_term.ID and tb_score.s_id='$s_id' and tb_course2_term.cb_id not in(214,215,216);");}
				else if($j==3){
				$sql2=mysql_query("select distinct c_longname,c_kind,c_week_hour,tb_score.c_credit,eff_score,tb_course_base.ID
				from tb_course_base,tb_score,tb_course2_term 
				where tb_course2_term.c_class='$now_class' and tb_course2_term.term='$grade_term' and tb_course_base.ID=tb_course2_term.cb_id and tb_score.c_id=tb_course2_term.ID and tb_score.s_id='$s_id' and  tb_course2_term.cb_id not in(106);");}
				    else
					{
				$sql2=mysql_query("select c_longname,c_kind,c_week_hour,tb_score.c_credit,eff_score,tb_course_base.ID
				from tb_course_base,tb_score,tb_course2_term 
