...
?>
<form name="form1" method="post" action="read_class_info.php" target="window" onsubmit="return f_tijao()"><!--输出表单头-->
...
<select name="class_name" id="class_name" on onchange='queryClass(this.options[this.selectedIndex].value)'></select> 
<!--显示数据的班级的位置-->
