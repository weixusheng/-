...
$class_name=$classes0;
$sql=mysql_query("select speciality,grade_code,major from tb_class where class_name='经贸101'");
...
->setCellValue('I3',$class_name)
			->mergeCells('I3:N3');
			$sql_0=mysql_query("select s_id from tb_score where s_term='$term' and s_id in (select ID from tb_s_information where now_class='$class_name' and (stu_status=0 or stu_status=4)) and c_id='$c_id';");
					
for($i=6;$i<36;$i++){
	$info_0=mysql_fetch_array($sql_0);
	$s_id=$info_0["s_id"];
