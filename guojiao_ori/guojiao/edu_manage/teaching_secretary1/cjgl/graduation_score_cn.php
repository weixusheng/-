      	...
      	<td>
            <table width="100%" height="40"border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td width="28%"colspan="2">毕业设计题目：<?php echo cleanString($topic_name,0,50);?></td>
                    <td width="12%"colspan="2">毕业设计成绩：<?php echo $grd_des_score;?></td>
                    <td width="10%"colspan="2"> 填表人：</td>
                    <td width="10%"colspan="2"> 负责人： </td>
