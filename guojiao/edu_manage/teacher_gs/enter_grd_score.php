...
<?php
$i=1;
$sql=mysql_query("select id,s_no,s_name,grd_dsg,t_name from graduation_design where class='$class'");
if($sql!=""){
$info=mysql_fetch_array($sql);	
	...
	do{
		...
		<td>$class</td>
		<td>$info[grd_dsg]</td>
		<td><input type='text' size='3' name='grade[]' value='' /><input type='hidden' name='score_id[]' value='$info[id]'></td></tr>";
	$i++;
...
<input  type="hidden" value="grd_score_form" name="way1" />
</table>
</form>
</body>
</html>