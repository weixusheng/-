...
?>
  ...
  <div class="head">
      ...
      <div class="nav" id="nav">
        <ul>
          <li><a class="thisclass" href="../teaching_secretary/cjgl/look_by_no.php" _for="first" target="main">常用管理</a></li>
      ...
      <div class="menu" id="menu">
        <div id="items_first">
          <dl id="dl_items_1_1">
            ...
            <dd>
              <ul>
                <li><a href="../teaching_secretary/cjgl/look_by_no.php" target="main" _for="cc">按学号查询</a></li>
                <li><a href="class_score_form.php" target="main" _for="cc">名单导出</a></li> 
              </ul>
            </dd>
          </dl>
        </div><!-- Item End -->
