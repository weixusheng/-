...
$objPHPExcel->setActiveSheetIndex(0)
			...
			->mergeCells('I1:M1')
			->setCellValue('O1', 'Transcript of Northeast Dianli University')
			->mergeCells('O1:W1')
			...
			->mergeCells('P3:R3')
			->setCellValue('S3', 'Degree：')
			->mergeCells('T3:V3')
			->setCellValue('W3', 'Graduation card number：')
			...
			->setCellValue('G45','Graduation Project Topic：')
			->setCellValue('J45','')
			->setCellValue('R45','Graduation Project Score:')
			->setCellValue('T45','')
			->setCellValue('V45','Completed by:')
			->setCellValue('Z45','Person charge:')
			->mergeCells('A45:B45')
			->mergeCells('E45:F45')
			->mergeCells('G45:I45')
			->mergeCells('J45:Q45')
			...
			for($j=1;$j<9;$j++)
			{
				...
				$sql2=mysql_query("select c_englishname,c_kind,c_week_hour,tb_score.c_credit,eff_score
