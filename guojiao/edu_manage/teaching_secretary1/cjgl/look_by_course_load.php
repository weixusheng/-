...
?>
<form name="form1" method="post" action="show_by_course1.php" target="window" onsubmit="return f_tijao()"><!--输出表单头-->
...
<select name="way">
  ...
  <option value="2">--重修考试1--</option>
  <option value="3">--重修考试2--</option>
  <option value="4">--重修考试3--</option>
</select> 
