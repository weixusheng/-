...
function checkform(){
   ...
   if((form1.npwd.value!=form1.qrpwd.value)&&(form1.npwd.value!="")&&(form1.qrpwd.value!=""))
...
<body style="height:400px" class="ziye_style">
<?php 
	//$s_no=$_SESSION["no"];
...
<table width="451" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td  class="guide">
      <input name="npwd" type="password" id="npwd" maxlength="15" />登录密码不超过15个字符</td>
  </tr>
  <tr>
    <td height="25" class="guide"></td>
  </tr>
  <tr>
    <td height="26">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td class="guide">
      <input name="qrpwd" type="password" id="qrpwd" maxlength="15" />再输入一次密码，确保密码正确</td>
  </tr>
  <tr>
    <td height="25" ></td>
  </tr>
  ...
  <tr>
    <td height="25"><table width="451" border="0" cellspacing="0" cellpadding="0">
      <tr>
