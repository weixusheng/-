...
$getsql=mysql_query("select c_no,c_name,credit,score,exam_type,verify,bk_score,c_kind,bk_type,bk_verify,ck1_score,ck1_type,ck1_verify,ck2_score,ck2_type,ck2_verify,ck3_score,ck3_type,ck3_verify,evaluate from stu_info where s_no='$s_id' and term='$s_term' and score is not NULL;");		
$getinfo=mysql_fetch_array($getsql);
	...
	<tr >
		...
		<td width="8%">&nbsp;<?php 
		if($getinfo["verify"]==0) echo "未审核";
		elseif($getinfo["evaluate"]==0) echo "未评教";
		else echo $score; ?>
		</td>
        <td width="10%">正考</td>
...
<tr >
		...
		<td width="8%">&nbsp;<?php echo $getinfo["credit"]; ?></td>
		<td width="8%">&nbsp;<?php 
		if($getinfo["bk_verify"]==0) echo "未审核";
		elseif($getinfo["evaluate"]==0) echo "未评教";
		else echo $score; ?>
		</td>
<td width="10%">补考</td>
	...
	<tr >
	  <td width="11%">&nbsp;<?php echo $getinfo["c_no"]; ?></td>
		...
		<td width="8%">&nbsp;<?php echo $getinfo["credit"]; ?></td>
		<td width="8%">&nbsp;<?php 
		if($getinfo["ck1_verify"]==0) echo "未审核";
		elseif($getinfo["evaluate"]==0) echo "未评教";
		else echo $score; ?>
		</td>
        <td width="10%">重修考试</td>
	...
	<tr >
		...
		<td width="8%">&nbsp;<?php echo $getinfo["credit"]; ?></td>
		<td width="8%">&nbsp;<?php 
		if($getinfo["ck2_verify"]==0) echo "未审核";
		elseif($getinfo["evaluate"]==0) echo "未评教";
		else echo $score; ?>
		</td>
	...
	<tr >
		...
		<td width="8%">&nbsp;<?php echo $getinfo["credit"]; ?></td>
		<td width="8%">&nbsp;<?php 
		if($getinfo["ck3_verify"]==0) echo "未审核";
		elseif($getinfo["evaluate"]==0) echo "未评教";
		else echo $score; ?>
		</td>
